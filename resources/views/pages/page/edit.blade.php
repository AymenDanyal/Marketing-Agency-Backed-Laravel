...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <div class="p-5">
                <div class="text-left">
                    <h1 class="h4 mb-4 text-gray-900">Edit Page</h1>
                </div>
                <form action="{{ route('pages.update', ['id' => $page->id]) }}" class="user" method="POST">
                    @method('PUT')
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="row form-group">
                        <div class="col-sm-12 mb-3">
                            ...
                            <input name="name" value="{{ $page->name }}" class="form-control" placeholder="Page Name" required>
                        </div>
                        <div class="col-sm-12 mb-3">
                            <label>Page Slug</label> 
                            <input name="slug" value="{{ $page->slug }}" class="form-control" placeholder="Page Slug" required>
                        </div>
                        <div class="col-sm-12 mb-3">
                        ...
                        <div class="col-sm-8 mt-2">
                            <button class="btn btn-block btn-primary btn-user" type="submit">Edit Page</button>
                        </div>
                    </div>
                </form>
            </div>
