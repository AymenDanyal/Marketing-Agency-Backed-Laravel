                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <div class="mb-3 w-100">
                                <select class="form-select col-sm-12" id="mediaType" name="media_type" required>
                                    <option value="" disabled {{ !$video->media_type ? 'selected' : '' }}>Select media type</option>
                                    <option value="reel" {{ $video->media_type == 'reel' ? 'selected' : '' }}>Reel</option>
                                    <option value="video" {{ $video->media_type == 'video' ? 'selected' : '' }}>Video</option>
                                    <option value="image" {{ $video->media_type == 'image' ? 'selected' : '' }}>Image</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12 mb-3">
